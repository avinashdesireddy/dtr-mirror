...
## Capture DTR Info
[ -z "$ucp_server" ] && read -p "Enter the UCP hostname and press [ENTER]:" ucp_server
[ -z "$dtr_server" ] && read -p "Enter the DTR hostname and press [ENTER]:" dtr_server
[ -z "$username" ] && read -p "Enter the username and press [ENTER]:" username
[ -z "$password" ] && read -s -p "Enter the password and press [ENTER]:" password
